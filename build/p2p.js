...
var discovery_swarm_1 = __importDefault(require("discovery-swarm"));
var dat_swarm_defaults_1 = __importDefault(require("dat-swarm-defaults"));
...
var myId = crypto_1.default.randomBytes(32);
 ...
 * Like a chat :)
 */
var askUser = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        rl = readline_1.default.createInterface({
            input: process.stdin,
            output: process.stdout,
        });
        rl.question("Send message: ", function (message) {
            // Broadcast to peers
            for (var id in peers) {
 ...
 */
var sw = discovery_swarm_1.default(config);
